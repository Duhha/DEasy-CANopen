...
OD_STATUS CANopen_OD_Bank(CANopen *canopen, uint16_t index, uint8_t sub_index, bool set, uint32_t *value, uint32_t *byte_size, OD_DATA_TYPE *data_type, uint8_t *byte_pointer, OD_ACCESS *access){
	...
	if(index == OD_INDEX_DEVICE_TYPE && sub_index == 0){
		...
		*data_type = sizeof(communication->pre_defined_error_field)/sizeof(communication->pre_defined_error_field[0]);
		...
		*data_type = sizeof(communication->manufacturer_device_name)/sizeof(communication->manufacturer_device_name[0]);
		...
		*data_type = sizeof(communication->manufacturer_hardware_version)/sizeof(communication->manufacturer_hardware_version[0]);
		...
		*data_type = sizeof(communication->manufacturer_software_version)/sizeof(communication->manufacturer_software_version[0]);
		...
		*data_type = sizeof(communication->store_parameters)/sizeof(communication->store_parameters[0]);
		...
		*data_type = sizeof(communication->restore_default_parameters)/sizeof(communication->restore_default_parameters[0]);
		...
		*data_type = sizeof(communication->verify_configuration)/sizeof(communication->verify_configuration[0]);
		...
		*data_type = sizeof(communication->emergency_consumer_object)/sizeof(communication->emergency_consumer_object[0]);
		...
		*data_type = sizeof(communication->error_behavior_object)/sizeof(communication->error_behavior_object[0]);
